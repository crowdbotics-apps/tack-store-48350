"""
Django settings for tack_store_48350 project.
...
ROOT_URLCONF = 'tack_store_48350.urls'
...
WSGI_APPLICATION = 'tack_store_48350.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tack_store_48350 API",
    "DESCRIPTION": "API documentation for tack_store_48350 App",
    "VERSION": "v1",
}
